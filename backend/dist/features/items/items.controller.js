...
let ItemsController = class ItemsController {
    ...
    create(dto, req) { return this.itemsService.create(dto, req.user.id); }
    update(id, dto) { return this.itemsService.update(id, dto); }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [item_dto_1.CreateItemDto, Object]),
    __metadata("design:returntype", void 0)
